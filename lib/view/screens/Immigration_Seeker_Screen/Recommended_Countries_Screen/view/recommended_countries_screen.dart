    ...
    return CustomGradient(
      child: Scaffold(
        appBar: CustomRoyelAppbar(
          ...
          titleName: "Recommended Countries",
          centerTitleEnable: false,
          rightOnTap: () {
            Get.to(FilterScreen());
          },
        ),
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Obx(() {
                  if (controller.rxRecommendedStatus.value == Status.loading &&
                  ...
                  return NotificationListener<ScrollNotification>(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount:
                          controller.recommendedCountries.length +
                          (controller.isRecommendedLoadMore.value ? 1 : 0),
