...
class _ChatListScreenState extends State<ChatListScreen> {
  ...
  //   final r = await SharePrefsHelper.getString("role");
  //   setState(() {
  //     role = r;
  //   });
  // }
  // Future<void> loadUserId() async {
  //   final id = await SharePrefsHelper.getString("UserId");
  //   setState(() {
  //     myIDLogin = id;
  //   });
  //   debugPrint("✅ Loaded role and id===============: $id");
  // }
                     ...
                     // if (index < filteredConversations.length) {
                        ...
                        return GestureDetector(
                          ...
                          child: CustomMessageList(
                            ...
                            img:AppConstants.profileImage2, //'${ApiUrl.baseUrl}/${participant.photo}',
                          ),
                        );
                      }
                      // else {
